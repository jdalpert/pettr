		...
		return(
			<div className="container mission main-content">
				...
				<p id="mission_text">Welcome to our Mission Statement! You will find information about
 				...
 				<p id="mission_text">We are a group of students from UCI who is currently taking a project
 				class in Informatics. Our project is to develop a web application for the adoption of pets. We are a team who is
 				enthusiastic about animals and bringing an end to pet homelessness. Our team members are as follows:
 				...
 				what we can accomplish as a team, but it is also our goal to help connect as many people with animals
